...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/report-writing/provider", label: "Letters", description: "Dictate or generate letters from clinical notes" },
      { href: "/report-writing/provider/training", label: "Typist Training", description: "Upload template examples and add rules for AI letter generation" },
    ],
  },
  {
    label: "Typist",
