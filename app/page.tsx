...
const cards = [
  {
    ...
    href: "/billing",
    description: "Generate service fee statements, locking, exports, and statement email workflows.",
  },
  {
    title: "Enter Lab, Materials & Incorrect Payments",
    href: "/patient-entries",
    description: "Record details of implants, material costs, and incorrect patient payment adjustments.",
  },
  {
    title: "Enter Merchant Fees",
    href: "/billing-details",
    description: "Record merchant fees and any other supporting billing detail entries.",
  },
  {
    title: "Edit Implant & Material Costs",
    href: "/material-costs",
    description: "Update common implant and material cost presets used across billing.",
  },
  {
    title: "Financial Dashboard",
    href: "/financials",
    description: "Review charts, trends, and month-to-month financial performance.",
  },
  {
  ...
  },
  {
    title: "Admin",
    href: "/admin",
    description: "Manage user access, permissions, edit providers and benchmarks.",
  },
];
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-base leading-7 text-slate-600">
                Welcome to the Focus Dental Specialists Service Fee Portal. Enter implant, lab and materials costs, record details of incorrect payments, and generate service fee statements from one central dashboard.
          ...
          <div className="mb-5 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                Select a section to manage billing, fees, providers, and reporting.
              </p>
            </div>
          </div>
